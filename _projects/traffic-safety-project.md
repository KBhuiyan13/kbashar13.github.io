...
- Detects motorcyclists, their helmets and license plates
- Performs in diverse and cluttered urban environments
- Helps identify riders without helmets, registration validity and vehicle tracking

## Technologies

- YOLOv8 model
- Mosaic Data-loader
- Jupyter Notbook and Python
